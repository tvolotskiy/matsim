...
public class PrivateATOptimizerProvider implements Provider<TaxiOptimizer> {
	...
	@Inject
	public PrivateATOptimizerProvider(TaxiConfigGroup taxiCfg, @Named(DvrpModule.DVRP_ROUTING) Network network,
	...
	public TaxiOptimizer get() {
		...
		TaxiOptimizerContext optimContext = new TaxiOptimizerContext(fleet, network, qSim.getSimTimer(),
