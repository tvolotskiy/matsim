...
public final class VehKmAndHReference {
	...
	public static void main(String[] args) throws IOException	{
		VehKmAndHReference cs = new VehKmAndHReference(args[0]);
		
		cs.run(args[1], args[2], args[3]);
		
	}
	
	private VehKmAndHReference(String shpFile)	{
				...
				public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException	{
					...
					if(qName.equalsIgnoreCase("event"))	{
						...
						if(attributes.getValue("type").equals("left link"))	{
							if (driver2vehicle.containsValue(attributes.getValue("vehicle")) && linkLength.containsKey(attributes.getValue("link")))	{
