...
public class RunBoth {
	public static void main(String[] args) {
		...
		RunBoth.run(configFile, false);
	}

	public static void run(String configFile, boolean otfvis) {
		Config config = ConfigUtils.loadConfig(configFile, new PConfigGroup(), new DvrpConfigGroup(), new TaxiConfigGroup(),
